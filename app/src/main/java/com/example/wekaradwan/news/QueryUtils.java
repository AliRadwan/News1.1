...
public final class QueryUtils {
    ...
    private static List<Data> extractFeatureFromJson(String newsJSON) {
        ...
        // Create an empty ArrayList that we can adding the data
    ...
    /**
     * Query the USGS dataset and return a list of {@link Data} objects.
     */
    public static List<Data> fetchNewsData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of {@link Data}s
